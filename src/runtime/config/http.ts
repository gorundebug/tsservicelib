...
export function isHttpDataConnectorConfig(
  value: DataConnectorConfig | undefined
): value is HttpDataConnectorConfig {
  return (
    value?.type === 1 &&
...
export function requireHttpDataConnectorConfig(
  value: DataConnectorConfig | undefined
): HttpDataConnectorConfig {
...
export function isHttpEndpointConfig(
  value: EndpointConfig | undefined
): value is HttpEndpointConfig {
  return (
    value !== undefined &&
...
export function requireHttpEndpointConfig(value: EndpointConfig | undefined): HttpEndpointConfig {
