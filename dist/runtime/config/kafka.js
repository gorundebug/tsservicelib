export function isKafkaDataConnectorConfig(value) {
    return (value?.type === 3 &&
        "brokers" in value &&
...
export function requireKafkaDataConnectorConfig(value) {
    if (!isKafkaDataConnectorConfig(value)) {
        throw new Error("invalid Kafka data connector config");
    }
    return value;
}
export function isKafkaEndpointConfig(value) {
...
export function requireKafkaEndpointConfig(value) {
