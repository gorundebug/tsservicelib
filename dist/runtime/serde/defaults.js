...
export const boolSerdeType = new SerdeType("bool", (value) => isBoolean(value));
...
export const float32SerdeType = new SerdeType("float32", (value) => isNumber(value));
export const float64SerdeType = new SerdeType("float64", (value) => isNumber(value));
...
export function makeDefaultSerdeRegistry() {
...
function makeArrayType(name, elementType) {
    return new SerdeType(name, (value) => Array.isArray(value) && value.every((item) => elementType.is(item)));
}
