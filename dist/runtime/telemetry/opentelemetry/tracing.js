...
export class OpenTelemetryTracingEngine {
    ...
    constructor(options) {
        ...
        this.#temporalProcessor = new TemporalBatchSpanProcessor(new TemporalOTLPTraceExporter(exporterOptions(options)), options.batch);
        this.#provider = new NodeTracerProvider({
            resource,
            sampler: new ParentBasedSampler({ root: new AlwaysOnSampler() }),
            spanProcessors: [processor]
        });
        this.#tracing = new OpenTelemetryTracing(this.#provider, new OpenTelemetryPlugin({
...
class OpenTelemetryTracing {
    #provider;
    #temporalPlugin;
    constructor(provider, temporalPlugin) {
...
function exporterOptions(options) {
